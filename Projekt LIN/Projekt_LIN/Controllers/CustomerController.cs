...
using DAL;
using Projekt_LIN.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using Projekt_LIN.Helpers;

namespace Projekt_LIN.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from Projekt_LIN", message);
